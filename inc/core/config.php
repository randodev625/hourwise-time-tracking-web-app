...
$dbCredentialsPath = $publicRoot . '/../secrets/db_credentials.php';
$emailSecretPath = $publicRoot . '/../secrets/email_secret.php';
$appSecretPath = $publicRoot . '/../secrets/app_secret.php';
...
return [
    ...
    'mail' => [
        'phpmailer_path' => $publicRoot . '/lib/PHPMailer',
